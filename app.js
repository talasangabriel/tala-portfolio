...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            formStatus.innerHTML = `Thank you, <strong>${name}</strong>! Your inquiry regarding <em>"${subject}"</em> has been received. Krystell will respond to <strong>${email}</strong> shortly.`;
